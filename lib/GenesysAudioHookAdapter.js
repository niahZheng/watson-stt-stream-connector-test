 ...
 * @param {*} request 
 */
function handleAudioHookConnection(webSocket, request) {
  ...
  function handleAudioData(data) {
    ...
    if (externalSpeechToTextEngine) {
      processReceivedData('external', externalSpeechToTextEngine, sessionState, external);
    }
    
    if (internalSpeechToTextEngine) {
      processReceivedData('internal', internalSpeechToTextEngine, sessionState, internal);
    }
  }
